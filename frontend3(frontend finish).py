...
class Beranda:
    ...
    def tertekan(self):
        ...
        self.switch_btn = Button(self.frame2,bg="WHITE",image=self.switch_tidak_ada,borderwidth=0,command=self.switch)
...
def appendCad():
        ...
        for i in range(k):
            ...
            btnTask[i] = Button(b.frame,image = b.gambar2,text="hallo "+str(i),command =b.tertekan)
            if kontainer == 1:
                if k<=maksJob:
